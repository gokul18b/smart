...
public class PojoEvaluvationUniversity {
    ...
    @JsonProperty("data")
    private List<DatumUniversity> data = null;
    @JsonIgnore
    ...
    @JsonProperty("data")
    public List<DatumUniversity> getData() {
        return data;
    }

    @JsonProperty("data")
    public void setData(List<DatumUniversity> data) {
        this.data = data;
    }
